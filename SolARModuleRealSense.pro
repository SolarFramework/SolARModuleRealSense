...
HEADERS += interfaces/SolARRealSenseAPI.h \
    interfaces/SolARModuleRealSense_traits.h \
    interfaces/SolARRGBDCameraRealSense.h

SOURCES += src/SolARModuleRealSense.cpp \  
    src/SolARRGBDCameraRealSense.cpp
